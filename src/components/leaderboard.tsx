      ...
      <Drawer.Portal>
        ...
        <Drawer.Content
          className={`fixed bottom-0 left-0 w-full transition-all duration-500 ease-in-out ${
            isFullScreen ? "h-screen" : "h-[60vh]"} bg-leaderboardBg z-50 rounded-t-3xl p-3`}>
          ...
          <div className="flex items-center justify-between p-4">
            ...
            <Button size="icon" variant="ghost" onClick={toggleLeaderboard} className="text-white">
              <X />
            </Button>
          </div>

          <div className={`px-4 sm:px-8 md:px-10 lg:px-12 overflow-y-auto`} 
            style={{maxHeight: isFullScreen ? "calc(100vh - 80px)" : "calc(60vh - 80px)", paddingBottom: isFullScreen ? "2rem" : "2rem",}}>
